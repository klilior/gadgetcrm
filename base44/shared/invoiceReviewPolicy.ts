...
/** Shared review rules. Pure: used by the review UI and server-side classification. */
...
export function stableLinePattern(value) {
  ...
  // Dates and numbers alone are never product identities.
...
export function monetaryCorrectionExample(original, edited, context = {}) {
  ...
  return {
    ...
    // Examples guide another reading; never supply a future invoice's amount.
    evidence_only: true
  };
}
