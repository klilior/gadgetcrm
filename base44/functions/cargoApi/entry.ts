...
function buildPackingSms({ name, shipment_type, tracking_number }) {
  ...
  const opening = shipment_type === 'exchange'
    ? 'שליח קארגו יגיע עם המוצר החלופי ויאסוף את הקיים.'
    : 'שליח קארגו יגיע לאיסוף המוצר.';
  return `שלום ${firstName},
${opening}
לפני האיסוף:
1. לארוז בקרטון או עטיפה סגורה, לא מוצר חשוף.
2. להסיר חשבון מהמכשיר (Apple ID / Google) ולבטל קוד נעילה.
