...
function AppContent({ children, currentPageName }) {
  ...
  if (isTechnicianRole) {
    ...
    if (isManager) {
      settingsMenuItems = [
        ...
        { title: "מיפוי קבוצות עמלות", url: createPageUrl("CommissionGroupMappings") },
  ...
  return (
    <div dir="rtl" className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 font-sans">
