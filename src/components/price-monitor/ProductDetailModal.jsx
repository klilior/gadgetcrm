      ...
      <DialogContent className="sm:max-w-2xl max-h-[80vh] overflow-y-auto" dir="rtl">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 text-sm">
            ...
            <div className="p-3 bg-gray-50 rounded-lg">
              <span className="text-gray-500 text-xs">בדיקה אחרונה</span>
              <div className="font-bold text-xs">
                {product.last_check_time ? format(new Date(product.last_check_time), "dd/MM/yy HH:mm") : "טרם"}
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-3 flex-wrap text-xs">
            {product.zap_comparison_url && (
              <a href={product.zap_comparison_url} target="_blank" rel="noopener noreferrer"
                className="text-blue-600 hover:underline">🔗 Zap השוואה</a>
            )}
            {product.my_woocommerce_url && (
              <a href={product.my_woocommerce_url} target="_blank" rel="noopener noreferrer"
                className="text-blue-600 hover:underline">🛒 WooCommerce</a>
            )}
          </div>
