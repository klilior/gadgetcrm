...
import { PhoneIncoming, PhoneOutgoing, PhoneMissed, User, ExternalLink, Clock, Lightbulb, Copy } from 'lucide-react';
...
export default function CallLogItem({ call, client, aiTip, dupCount }) {
    ...
    return (
        <div className="px-4 py-3 hover:bg-gray-50 transition-colors">
            ...
            {/* AI Tip - only for identified clients */}
            {client && aiTip && aiTip !== 'אין מידע' && aiTip !== 'אין פעילות ידועה' && (
                <div className="mt-2 mr-13 flex items-start gap-2 bg-amber-50 border border-amber-200 rounded-lg px-3 py-2 mr-[52px]">
